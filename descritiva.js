...
function qualitativa(vetor) {
    ...
    graficoQuali(vet2, freq)
}

function quantitativa(vetor, tipoVar, tipoDados) {
    // STRING PARA NUMBER
    for (let i = 0; i < vetor.length; i++) {
...
function graficoQuali(vet2, freq) {
    // NOME VARIÁVEL
    var nome = document.getElementById('nomeVar').value
    ...
    document.getElementById("chartContainer").innerHTML = '<canvas id="myChart" width="600" height="400"></canvas>'
...
function graficoDiscreta(vet2, freq) {
    // NOME VARIÁVEL
    var nome = document.getElementById('nomeVar').value
...
function graficoContinua(vetMin, freq) {
    // NOME VARIÁVEL
    var nome = document.getElementById('nomeVar').value
